...
const TYPED_LINES = [
  ...
  "...",
  "> and its the first we're all not there with you",
  "...",
  "> so we thought we come to you!",
  "٩(◕‿◕)۶"
];
    ...
    <>
      <group ref={tableGroup}>
        ...
        <PictureFrame
          ...
          scale={0.75}
        />
        {/* Additional side frames on the table */}
        <PictureFrame
          image="/frame5.jpg"
          position={[1.8, 0.735, 2.2]}
          rotation={[0, 5.3, 0]}
          scale={0.7}
        />
        <PictureFrame
    ...
    <div className="App">
      ...
      >
        <Suspense fallback={null}>
          ...
          />
          {/* Slightly brighter overall lighting and environment */}
          <ambientLight
            intensity={(1 - environmentProgress) * 0.6 + 0.25}
          />
          <directionalLight
            intensity={0.7}
            position={[4, 10, 2]}
          ...
          <Environment
            ...
            background
            environmentIntensity={0.25 * environmentProgress}
            backgroundIntensity={0.18 * environmentProgress}
          />
          <EnvironmentBackgroundController
            intensity={0.18 * environmentProgress}
          />
